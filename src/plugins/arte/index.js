...
const channel = {
  ...
  async show(request, response) {
    const res = await fetch(`${this.baseReplayUrl}programs/${request.date.getFullYear()}/fr`)
    ...
    try {
      ...
      response.locals.variables = data.programs
  ...
  async video(request, response) {
    const { baseUrl } = request
    const res = await fetch(`${this.baseReplayUrl}streams/${request.params.videoId}/fr`)
    ...
    try {
      ...
      data.videoStreams.forEach((video) => {
